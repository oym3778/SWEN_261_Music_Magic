...
/**
 * Implements the functionality for JSON file-based peristance for ufund
 * 
...
public class NeedFileDAO implements NeedDAO {
    ...
    /**
     * Generates an array of {@link Need needs} from the tree map for any
     * {@link Need needs} that contains the text specified by containsText
     * <br>
     * If containsText is null, the array contains all of the {@link Need needs}
     * in the tree map
     * 
     * @return  The array of {@link Need needs}, may be empty
     */
    ...
    /**
     * Saves the {@link Need needs} from the map into the file as an array of JSON objects
     * 
    ...
    ** {@inheritDoc}
    ...
    public Need createNeed(Need need) throws IOException {
        synchronized(needs) {
            ...
            Need newNeed = new Need(nextId(),need.getName(), need.getPrice(), need.getQuanity());
